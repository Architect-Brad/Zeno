...
Continuous short-chunk recording with VAD-based activation.
Uses termux-microphone-record for raw audio when available;
falls back to periodic STT polling on other platforms.
"""
