...
_SYNONYM_GROUPS: list[set[str]] = [
    ...
    # Smart home
    {"light", "lamp", "illumination", "luminosity", "illuminate", "brighten"},
    ...
    {"now", "currently", "presently", "right now"},
    {"quick", "fast", "rapid", "speedy"},
    {"slow", "gradual", "steady"},
    {"big", "large", "huge", "enormous", "massive"},
    {"small", "tiny", "little", "mini", "compact"},
    {"new", "fresh", "latest", "recent", "current"},
    ...
    {"tired", "exhausted", "sleepy", "drowsy", "weary"},
    {"angry", "mad", "furious", "irritated", "annoyed", "upset"},
    {"beautiful", "gorgeous", "stunning", "lovely", "pretty", "attractive"},
    {"important", "essential", "crucial", "vital", "significant", "critical", "key"},
    ...
    {"very", "extremely", "incredibly", "highly", "remarkably", "quite", "rather"},
    {"like", "enjoy", "love", "adore", "fancy", "prefer"},
    {"dislike", "hate", "detest", "loathe", "despise", "can't stand"},
    {"need", "require", "want", "desire", "must have", "could use"},
    {"know", "understand", "comprehend", "grasp", "realize", "recognize"},
    {"think", "believe", "suppose", "consider", "reckon", "feel"},
    {"guess", "estimate", "approximate", "roughly", "approximately"},
    {"change", "alter", "modify", "adjust", "convert", "transform", "switch"},
    {"create", "make", "build", "construct", "form", "produce", "generate", "craft"},
    {"remove", "delete", "erase", "eliminate", "clear", "wipe", "discard", "drop"},
    {"add", "include", "insert", "append", "attach", "incorporate", "plus"},
    {"increase", "raise", "elevate", "boost", "enhance", "amplify", "augment", "grow"},
    {"decrease", "reduce", "lower", "diminish", "lessen", "cut", "shrink", "drop", "minimize"},
    {"learn", "study", "research", "explore", "discover", "investigate"},
    {"teach", "educate", "instruct", "train", "coach", "guide", "mentor"},
    {"try", "attempt", "endeavor", "strive", "seek", "aim"},
    {"finish", "complete", "end", "finalize", "conclude", "wrap up", "done"},
    {"wait", "stay", "remain", "hold on", "hang on", "pause"},
    {"remember", "recall", "recollect", "remind"},
    {"forget", "ignore", "overlook", "neglect", "disregard"},
    {"meet", "see", "encounter", "greet", "welcome", "connect with"},
    {"leave", "depart", "exit", "go", "withdraw", "retreat"},
    {"arrive", "come", "reach", "enter", "approach", "show up"},
    {"walk", "stroll", "wander", "roam", "hike", "march", "pace"},
    {"run", "jog", "sprint", "dash", "race", "rush"},
    {"sleep", "rest", "nap", "doze", "slumber", "snooze"},
    {"wake", "awake", "awaken", "rise", "get up", "wake up"},
    {"work", "labor", "toil", "effort", "exertion"},
    {"play", "game", "gaming", "recreation", "leisure", "fun"},
]
